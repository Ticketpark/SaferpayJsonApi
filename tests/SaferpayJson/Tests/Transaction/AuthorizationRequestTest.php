...
class AuthorizationRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $initializer = new AuthorizationRequest();
    ...
    public function testSuccessfulResponse()
    {
        ...
        $this->assertInstanceOf('Ticketpark\SaferpayJson\Transaction\AuthorizationResponse', $response);
    }
    ...
    public function getResponseMock($successful)
    {
        ...
        if ($successful) {
            $content = $this->getFakedApiResponse('Ticketpark\SaferpayJson\Transaction\AuthorizationResponse');
        } else {
