...
class AuthorizeDirectRequestTest extends \PHPUnit_Framework_TestCase
{
    public function testErrorResponse()
    {
        $initializer = new AuthorizeDirectRequest();
    ...
    public function testSuccessfulResponse()
    {
        ...
        $this->assertInstanceOf('Ticketpark\SaferpayJson\Transaction\AuthorizeDirectResponse', $response);
    }
    ...
    public function getResponseMock($successful)
    {
        ...
        if ($successful) {
            $content = $this->getFakedApiResponse('Ticketpark\SaferpayJson\Transaction\AuthorizeDirectResponse');
        } else {
